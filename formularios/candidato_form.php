...
<table width="70%" class="acordeon" align="center" ><tr><td onclick="muestra_oculta('dvDireccion')" >Direcciones </td><td align="right"><img src="imagenes/add.png" width="16" height="16" alt="add"/></tr></table>
<div id='dvDireccion' >
    <form id="formdireccion" name="formdireccion" >
        ...
        <table border="0" align="center" width="70%">
            <tr>
                ...
                <td width="20%">
                    <input type="text" name="txtPrincipal" id="txtPrincipal" value="" size="30"/>
                </td>
                <td width="20%">
                    <input type="text" name="txtSecundaria" id="txtSecundaria" value="" size="30"/>
                </td>
                <td width="10%">
                    <input type="text" name="txtnro" id="txtnro" value="" size="5"/>
                </td>
                <td width="20%">
                    <input type="text" name="txtReferencia" id="txtReferencia" value="" size="30"/>
                </td>
                <td width="20%">
                    <input type="text" name="txtReferencia" id="txtReferencia" value="" size="30"/>
                </td>
