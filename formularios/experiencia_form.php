...
<table border='0' align='center'>
	...
	<tr> 
		 ...
		 <td> 
			 <select name='empresa' id='empresa' onchange=''><option value=''>Seleccione...</option></select> 
		 </td>
		 ...
		 <td> 
			 <input type='text' name='cargo' id='cargo' value='' onfocus='' size='192'> 
		 </td>
 	</tr>
	<tr> 
		 <td> 
		 ...
		 <td> 
			 <textarea name='tareas' id='tareas' onchange='' cols='-1'></textarea> 
		 </td>
